package game.module.pvp.views.ui
{
	...
	public class PvpShopCell extends PvpShopCellUI
	{
		...
		override protected function createChildren():void {
			...
			var mp3Url:String = ResourceManager.getSoundUrl('ui_dialog_buy','uiSound');
...
//				this.buyNum.text = _data.showCosts[0].inum;
				...
				var state:Boolean = _data.state;
				this.buyBtn.disabled = !state;
				if( sy == 0 )
				{
					this.buyBtn.disabled = true;
				}
				this.bg.filters = _data.state ? null : [UIUtils.grayFilter];
				this.errLbl.visible = !state;
