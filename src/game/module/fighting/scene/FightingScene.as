...
//							trace("未上阵");
		...
		override public function initScence():void
		{
			...
			//调整瓦片层、人物层、技能层的位置,之前的人物层太靠近上顶层导致最上面一个角色血条无法显示【新手引导位置出错先改回去】
//			gridSp.x = -200;
//			gridSp.y = 100;
//			tileLayer.x = -200;
//			tileLayer.y = 100;
...
//				)
		...
		public function selectUnit(upos:String):void{
			...
			{
				_lastBaseUnit.select = false;
			}
			_lastBaseUnit = un;
			
			this.timer.once(2000,this,autoHideSelectedArrow,[un]);
		}
		
		private var _lastBaseUnit:BaseUnit;
		
		private function autoHideSelectedArrow(u:BaseUnit):void {
