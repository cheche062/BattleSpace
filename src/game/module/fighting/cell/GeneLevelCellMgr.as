package game.module.fighting.cell
{
	...
	public class GeneLevelCellMgr
	{
		...
		public function GeneLevelCellMgr(ui:Node)
		{
			...
			countLbl = ui.getChildByName("countLbl");
		...
		public function set data(v:Object):void
		{
			...
			if(vo)
			{
				...
				if(_data.free_number){
					_cStr = _data.free_number;
				}
//				countLbl.color = Number(_cStr) - _data.combat_number > 0 ? "#27e219" : "#ee2311";
				var count:int = Number(_cStr) - _data.combat_number > 0 ? Number(_cStr) - _data.combat_number : 0;
				countLbl.text = count + "/" + _cStr;
				countLbl.visible = vo.type == "1";
			}
		}
