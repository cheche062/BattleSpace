...
//				obj.free_number = fn;
		...
		private function refreshFun():void
		{
			...
			ConsumeHelp.Consume([rwitem],Handler.create(this,refreshSend),(GameLanguage.getLangByKey("L_A_38047")+'@'+GameLanguage.getLangByKey("L_A_171")));
		}
