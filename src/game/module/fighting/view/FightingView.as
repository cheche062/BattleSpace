...
package game.module.fighting.view
{
	...
	public class FightingView extends BaseView
	{
		...
		public  var isFightStart:Boolean = true;
...
//			}
		...
		{
//			return ;
			if(_showType == SHOWTYPE_5 || _showType == SHOWTYPE_7)
			{
...
//			});
		...
		private function gotoSendStartBackDataTimer():void
		{
			...
			this.rightTopView1.auboBtn.visible = showAutoBtn && _showType != SHOWTYPE_7;
			this.rightTopView1.escapeBtn.visible = User.getInstance().hasFinishGuide && _showType != SHOWTYPE_7;
...
//			scence.jianche();
		...
		public function setType(type:uint , isMove:Boolean = false):void
		{
			if(_showType != type)
			{
				...
				Image(rightTopView1.backBtn.getChildByName("iconImg")).skin = "fightingUI/icon_escape.png";
				...
				switch(_showType)
				{
					case SHOWTYPE_2:   //战报播放
					{
						...
						rightTopView1.backBtn.visible = User.getInstance().hasFinishGuide;
						// 暂时伪装一下皮肤
						rightTopView1.backBtn.label = "L_A_117";
						Image(rightTopView1.backBtn.getChildByName("iconImg")).skin = "fightingUI/icon_end.png";
						scence.mapScale1 = 1;
						if( User.getInstance().inToPvp )
						{
							rightTopView1.velocityBtn.visible = true;
							rightTopView1.velocityBtn.label = "x"+1;
						}
