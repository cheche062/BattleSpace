package game.module 
{
	...
	public class newerGuideView extends BaseView 
	{
		...
		private var _resetGuideId:String;
		...
		public function get resetGuideId():String
		{
			return _resetGuideId;
		}

		public function set resetGuideId(value:String):void
		{
			_resetGuideId = value;
		}
		...
		public function onClick(e:Event=null):void
		{
			...
			//新手引导的第一次战斗的六次点击需要上报
			var obj = {
				"1" : "the_first_battle",//进入游戏初始战斗开始
				"3" : "the_first_battle_click_1",//第1次用户点击行为
				"5" : "the_first_battle_click_2",//第2次用户点击行为
				"7" : "the_first_battle_click_3",//第3次用户点击行为
				"8" : "the_first_battle_click_4",//第4次用户点击行为
				"9" : "the_first_battle_end",//第5次用户点击行为,初始战斗结束
				"101" : "guide_101",
				"102" : "guide_102",
				"103" : "guide_103",
				"105" : "guide_105",
				"107" : "back_base",//回到主基地建造训练营，点击确定
				"108" : "training",//在训练营训点击“训练”，训练一个兵种
				"109" : "speed_up_training",//在训练营训点击“训练”，训练一个兵种
				"110" : "1th_enter_quset_1_battle",//首次进入主线推图1-1
				"114" : "start_quest_1_battle",//主线推图1-1，点击开战按钮开始战斗
				"116" : "quest_1_frist_click_2",//1-1 历史首次第2次点击行为
				"117" : "quest_1_frist_click_4",//1-1 历史首次第4次点击行为
				"118" : "quest_1_battle_end",//主线推图1-1，战斗结束，点击返回
				"201" : "2th_enter_battle_main",//历史第二次返回战役主界面
				"204" : "frist_click_quest_2_battle_attack",//历史首次点击1-2并进入
				"208" : "start_quest_2_battle",//主线推图1-2，点击开战按钮开始战斗
				"210" : "quest_2_frist_click_1",//1-2 第1次攻击
				"213" : "quest_2_frist_click_2",//1-2 第2次攻击
				"214" : "3th_enter_battle_main",//1-2结束，返回战役主界面
				"272" : "click_ente_for_draw_card",//根据引导提示，点击“进入”按钮，进入抽卡建筑
				"273" : "draw_card",//抽卡
				"274" : "draw_card_click_1",//抽卡点击行为1
				"275" : "draw_card_click_2",//抽卡点击行为2
				"276" : "draw_card_click_3",//抽卡点击行为3
				"294" : "guide_294",//
				"295" : "guide_295",//
				"296" : "guide_296",//
				"297" : "guide_297",//
				...
				"306" : "guide_306",//
				"307" : "guide_307",//
				"309" : "start_quest_3_battle",//主线推图1-3，点击“开战”按钮开始战斗
				"310" : "quest_3_battle_end",//主线推图1-3，战斗结束，点击“返回”
				"351" : "guide_351",//
				"352" : "guide_352",//
				"353" : "guide_353",//
				"354" : "guide_354",//
			...
			switch(guideStep)
			{
				...
				case 111:
					...
					view.arrowMotion.x = p.x+((XFacade.instance.getView(FightingView) as FightingView).selectUnitView.m_list.getCell(0).width-view.arrowMotion.width)/2;
					view.arrowMotion.y = p.y - view.arrowMotion.height;
					view.arrowMotion.visible = true;
					
					showCircelAnimation(p.x + (XFacade.instance.getView(FightingView) as FightingView).selectUnitView.m_list.getCell(0).width / 2, 
						p.y + (XFacade.instance.getView(FightingView) as FightingView).selectUnitView.m_list.getCell(0).height / 2);
					break;
				case 112:
					onClick();
					break;
				...
				case 115:
					...
					view.normalDes.visible = true;
					view.normalDes.y = 0;//LayerManager.instence.stageHeight * 0.1;
					view.introWithMan.visible = false;
				...
				case 116:
					...
					view.arrowMotion.rotation = 180;
					view.arrowMotion.x = p.x+75;
					view.arrowMotion.y = p.y+250;
					view.arrowMotion.visible = true;
					this.mouseThrough = view.mouseThrough  = true;
					
					showCircelAnimation(p.x+35,p.y+25);
					break;
				case 117:
					...
					break;
				case 118:
					IsUIOpened(FightResultPanel,function():void
					{
						_resetGuideId = "118";
						p = drawBlankArea((XFacade.instance.getView(FightResultPanel) as FightResultPanel).getCloseBtn());
						view.arrowMotion.x = p.x+(XFacade.instance.getView(FightResultPanel).getCloseBtn().width-view.arrowMotion.width)/2;
						view.arrowMotion.y = p.y+(XFacade.instance.getView(FightResultPanel) as FightResultPanel).getCloseBtn().height - 230;
						view.arrowMotion.visible = true;
						
						showCircelAnimation(p.x + (XFacade.instance.getView(FightResultPanel).getCloseBtn().width) / 2, 
							p.y + (XFacade.instance.getView(FightResultPanel).getCloseBtn().height) / 2 - 5);
					});
				...
				case 205:
					...
					showCircelAnimation(p.x + (XFacade.instance.getView(FightingView).selectUnitView.m_list.getCell(0).width) / 2, 
						p.y + (XFacade.instance.getView(FightingView).selectUnitView.m_list.getCell(0).height) / 2);
					break;
				case 206:
					guideStep = 206;
					onClick();
				...
				case 296:
					...
					_resetGuideId = "296";
					IsUIOpened(TrainView,function():void
					{
				...
				case 309:
					...
					WebSocketNetService.instance.sendData(ServiceConst.SET_NEWER_GUIDE, [350]);
...
//					view.arrowMotion.y = -10;
					...
					view.introWithMan.visible = true;
					//from(view.introWithMan, { x: -980 },500);
					view.des1.text = GameLanguage.getLangByKey("L_A_20515");//"狙击手的攻击类型是穿透，其一大特性就是能够无视重甲的阻隔属性";
					TFMotion();
...
//					AndroidPlatform.instance.FGM_CustumEvent("650_stg3_dia3");
				...
				case 352:
					...
					view.arrowMotion.rotation = 180;
					view.arrowMotion.x = p.x+110;
					view.arrowMotion.y = p.y+210;
					view.arrowMotion.visible = true;
					
					showCircelAnimation(p.x + 75, p.y + 20);
				...
				case 353:
					...
					view.introWithMan.visible = false;
					//绘制输入框点击区域
					drawBlankArea((XFacade.instance.getView(SetPlayerNameView) as SetPlayerNameView).view.inputTxt);
//					p = drawBlankArea((XFacade.instance.getView(SetPlayerNameView) as SetPlayerNameView).view.confirmBtn);
					var p_x=(XFacade.instance.getView(SetPlayerNameView) as SetPlayerNameView).view.confirmBtn.x;
					var p_y=(XFacade.instance.getView(SetPlayerNameView) as SetPlayerNameView).view.confirmBtn.y;
					var p_stage:Point= new Point(0, 0);
					(XFacade.instance.getView(SetPlayerNameView) as SetPlayerNameView).view.confirmBtn.localToGlobal(p_stage);
//					view.arrowMotion.rotation = 180;
//					view.arrowMotion.x = p_stage.x+140;
//					view.arrowMotion.y = p_stage.y+220;
//					view.arrowMotion.visible = true;
//					
//					showCircelAnimation(p_stage.x + 95, p_stage.y + 30);
					view.arrowMotion.visible = false;
					hideBlankArea();
				...
				case 354:
					...
					// 强制到继续指向356
					guideStep = 355;
					WebSocketNetService.instance.sendData(ServiceConst.SET_NEWER_GUIDE, [355]);
					break;
...
//					//					AndroidPlatform.instance.FGM_CustumEvent("170_clk_stg1");
//					view.introWithMan.visible = false;
//					p = drawBlankArea((XFacade.instance.getView(ShowRewardPanel) as ShowRewardPanel).view.closeBtn);
//					view.arrowMotion.rotation = 180;
//					view.arrowMotion.x = p.x+110;
//					view.arrowMotion.y = p.y+200;
//					view.arrowMotion.visible = true;
//					
//					showCircelAnimation(p.x + 75, p.y + 40);
//					
//					this._guideBg.visible = false;
//					this.mouseThrough = view.mouseThrough  = true;
//					break;
				...
				case 401:
					...
					//					AndroidPlatform.instance.FGM_CustumEvent("170_clk_stg1");
					view.introWithMan.visible = false;
					p = drawBlankArea((XFacade.instance.getView(FightingMapScene) as FightingMapScene).getStageBtn('4'));
					view.arrowMotion.rotation = 180;
					view.arrowMotion.x = p.x+110;
					view.arrowMotion.y = p.y+310;
					view.arrowMotion.visible = true;
...
//					view.des2.text = GameLanguage.getLangByKey("L_A_39053");//"先派出我们的英雄";
				...
				case 403:				
//					AndroidPlatform.instance.FGM_CustumEvent("");					
					view.arrowMotion.visible = false;
					view.introWithMan.visible = false;
					view.normalDes.visible = false;
					pveFightiView.selectUnitView.unitTypeTab.selectedIndex = 1;
				...
				case 501:
					view.normalDes.visible = false;
					view.introWithMan.visible = true;
					view.des1.text = GameLanguage.getLangByKey("L_A_177");
					TFMotion();
					//开战了就算自动打了
		...
		private function missonStepHandler(cmd:String="", ...args):void 
		{
			...
			switch(guideStep)
			{
				case 105:
					...
					IsUIOpened(MainMenuView,function():void
					{
						Laya.timer.once(800, this, function() {
							_resetGuideId = "105";
							var tg:Sprite = (XFacade.instance.getView(MainMenuView) as MainMenuView).getBuilding();
							p = drawBlankArea(tg);
							...
							var toY:int = (XFacade.instance.getView(MainMenuView) as MainMenuView).getPoint().y;
							
							view.arrowMotion.visible = true;
							view.arrowMotion.rotation = 180;
							showCircelAnimation(tg.width / 2+10, toY + view.arrowMotion.height);
							view.arrowMotion.y = toY + view.arrowMotion.height + 160;
						})
					});
					this._guideBg.visible = false;
					break;
		...
		public function guildeEventhandler(cmd:String,...args):void 
		{
			...
			switch(cmd)
			{
				...
				case NewerGuildeEvent.PUT_BUILDING_OK:
					...
					_resetGuideId = NewerGuildeEvent.PUT_BUILDING_OK;
				...
				case NewerGuildeEvent.SELECT_SOILDER:
					...
					_resetGuideId = NewerGuildeEvent.SELECT_SOILDER;
				...
				case NewerGuildeEvent.CLICK_TRAIN_BTN:
					...
					_resetGuideId = NewerGuildeEvent.CLICK_TRAIN_BTN;
				...
				case NewerGuildeEvent.ENTER_FIGHT_MAP:
					...
					if (guideStep >= 200)
					{
						_resetGuideId = NewerGuildeEvent.ENTER_FIGHT_MAP + "2";
						missonStepHandler();
						return;
					}
					
					_resetGuideId = NewerGuildeEvent.ENTER_FIGHT_MAP + "1";
					view.des2.text = GameLanguage.getLangByKey("L_A_39088");
					view.normalDes.visible = true;
					view.normalDes.y = LayerManager.instence.stageHeight * 0.3;
				...
				case NewerGuildeEvent.SHOW_CHAPTER_PANEL:
					...
					_resetGuideId = NewerGuildeEvent.SHOW_CHAPTER_PANEL;
				...
				case NewerGuildeEvent.SELECT_MOVE:
					...
					_resetGuideId = NewerGuildeEvent.SELECT_MOVE;
				...
				case NewerGuildeEvent.SHIELD_SOILDER_ACT:
					if (guideStep == 115)
					{
						_resetGuideId = NewerGuildeEvent.SHIELD_SOILDER_ACT;
						view.introWithMan.visible = false;
						view.normalDes.visible = true;;
						this.mouseThrough = view.mouseThrough  = false;
						view.normalDes.y = LayerManager.instence.stageHeight * 0.1;
				...
				case NewerGuildeEvent.CHAPTER_ONE_OVER:
					...
					if (guideStep > 200)
					{
						if(guideStep<300)
						{
							...
							IsUIOpened(FightResultPanel,function():void
							{
								_resetGuideId = NewerGuildeEvent.CHAPTER_ONE_OVER + "2";
								p = drawBlankArea((XFacade.instance.getView(FightResultPanel) as FightResultPanel).getCloseBtn());
								view.arrowMotion.x = p.x+(XFacade.instance.getView(FightResultPanel).getCloseBtn().width-view.arrowMotion.width)/2;
								view.arrowMotion.y = p.y+(XFacade.instance.getView(FightResultPanel) as FightResultPanel).getCloseBtn().height - 230;
								view.arrowMotion.visible = true;
						...
						else
						{
							...
							IsUIOpened(FightResultPanel,function():void
							{
								_resetGuideId = NewerGuildeEvent.CHAPTER_ONE_OVER + "3";
								p = drawBlankArea((XFacade.instance.getView(FightResultPanel) as FightResultPanel).getCloseBtn());
								view.arrowMotion.x = p.x+(XFacade.instance.getView(FightResultPanel).getCloseBtn().width-view.arrowMotion.width)/2;
								view.arrowMotion.y = p.y+(XFacade.instance.getView(FightResultPanel) as FightResultPanel).getCloseBtn().height - 230;
								view.arrowMotion.visible = true;
				...
				case NewerGuildeEvent.FIGHT_CHAPTER_FOUR:
					//trace("进入战斗三");
				...
				case NewerGuildeEvent.CHANGE_CONTRIBUTE_LIST:
					if (guideStep > 300)
					{
						...
						p = drawBlankArea((XFacade.instance.getView(MainMenuView) as MainMenuView).view.pane.getChildAt(3));
						view.arrowMotion.x = p.x+((XFacade.instance.getView(MainMenuView) as MainMenuView).view.pane.getChildAt(3).width-view.arrowMotion.width)/2;
						view.arrowMotion.y = p.x;
						view.arrowMotion.visible = true;
						view.arrowMotion.rotation = 180;
						showCircelAnimation((XFacade.instance.getView(MainMenuView) as MainMenuView).view.pane.getChildAt(3).width / 2+10, 
							(XFacade.instance.getView(MainMenuView) as MainMenuView).view.pane.getChildAt(3).y + (XFacade.instance.getView(MainMenuView) as MainMenuView).view.pane.getChildAt(3).height / 2);
				...
				case NewerGuildeEvent.OPEN_SET_NOTE:
					...
					onClick();
					break;
				case NewerGuildeEvent.CLICK_GO_BTN:
					this.mouseThrough = view.mouseThrough  = false;
					Laya.timer.once(500, this, function() {
						stopAll = false;
						onClick();
...
//					onClick();
					break;
				case NewerGuildeEvent.GET_REWARD:
					this.mouseThrough = view.mouseThrough  = false;
					Laya.timer.once(500, this, function() {
						stopAll = false;
						onClick();
		...
		private function drawBlankArea(target:*, bdBlock:Boolean = false, isTile:Boolean = false):Point
		{
			...
			if (tagetSprite && tagetSprite.displayedInStage)
			{
				...
				switch(guideStep)
				{
					...
					{
						h += 100;
						pi = new Point(tagetSprite.x,tagetSprite.y - 100);
						break;
					}
					case 111:
					{
					...
					case 296:
					{
						if( _resetGuideId != NewerGuildeEvent.SELECT_SOILDER &&
							_resetGuideId != NewerGuildeEvent.CLICK_TRAIN_BTN )
							h -= 50;
						pi = new Point(tagetSprite.x,tagetSprite.y);
						break;
		...
		private function resetPos():void
		{
			...
			switch(_resetGuideId)
			{
				...
				case NewerGuildeEvent.ENTER_FIGHT_MAP + "1":
				{
					p = drawBlankArea((XFacade.instance.getView(FightingMapScene) as FightingMapScene).getStageBtn('1'));
					view.arrowMotion.x = p.x+110;
					if( !_isLoop || _loopNum > 1 )
				...
				case NewerGuildeEvent.ENTER_FIGHT_MAP + "2":
				{
					p = drawBlankArea((XFacade.instance.getView(FightingMapScene) as FightingMapScene).getStageBtn('2'));
					view.arrowMotion.x = p.x+110;
					if( !_isLoop || _loopNum > 1 )
				...
				case "118":
				case NewerGuildeEvent.CHAPTER_ONE_OVER + "2":
				case NewerGuildeEvent.CHAPTER_ONE_OVER + "3":	
				{
					p = drawBlankArea((XFacade.instance.getView(FightResultPanel) as FightResultPanel).getCloseBtn());
					view.arrowMotion.x = p.x+(XFacade.instance.getView(FightResultPanel).getCloseBtn().width-view.arrowMotion.width)/2;
					if( !_isLoop || _loopNum > 1 )
					{
						view.arrowMotion.scale((XFacade.instance.getView(FightResultPanel) as FightResultPanel).getCloseBtn().scaleX,(XFacade.instance.getView(FightResultPanel) as FightResultPanel).getCloseBtn().scaleY);
						view.arrowMotion.y = p.y+(XFacade.instance.getView(FightResultPanel) as FightResultPanel).getCloseBtn().height - 230;
						_loopNum = 0;
					}
				...
				case "353":
				{
					p = drawBlankArea((XFacade.instance.getView(SetPlayerNameView) as SetPlayerNameView).view.inputTxt);
//					view.arrowMotion.x = p.x+(pveFightiView.selectUnitView.fightBtn.width-view.arrowMotion.width)/2;
					var p_x=(XFacade.instance.getView(SetPlayerNameView) as SetPlayerNameView).view.confirmBtn.x;
					var p_y=(XFacade.instance.getView(SetPlayerNameView) as SetPlayerNameView).view.confirmBtn.y;
					var p_stage:Point= new Point(0, 0);
...
//					view.arrowMotion.y = p.y+(XFacade.instance.getView(MainView) as MainView).view.goBtn.height;
					showCircelAnimation(p.x + (XFacade.instance.getView(MainView) as MainView).view.goBtn.width / 2, 
						p.y + (XFacade.instance.getView(MainView) as MainView).view.goBtn.height / 2);
					break;
				}
		...
		override public function createUI():void {
			...
			this.view.normalDes.mouseEnabled = view.normalDes.mouseThrough = false;
		...
		override public function addEvent():void{
			...
			Signal.intance.on(NewerGuildeEvent.FIGHT_CHAPTER_FOUR, this, this.guildeEventhandler, [NewerGuildeEvent.FIGHT_CHAPTER_FOUR]);
			...
			Signal.intance.on(NewerGuildeEvent.CLICK_GO_BTN, this, this.guildeEventhandler, [NewerGuildeEvent.CLICK_GO_BTN]);
			Signal.intance.on(NewerGuildeEvent.GET_REWARD, this, this.guildeEventhandler, [NewerGuildeEvent.GET_REWARD]);
			super.addEvent();
		...
		override public function removeEvent():void{
			...
			Signal.intance.off(NewerGuildeEvent.FIGHT_CHAPTER_FOUR, this, this.guildeEventhandler);
			...
			Signal.intance.off(NewerGuildeEvent.CLICK_GO_BTN, this, this.guildeEventhandler);
			Signal.intance.off(NewerGuildeEvent.GET_REWARD, this, this.guildeEventhandler);
			
			super.removeEvent();
		}
		
		/**该UI是否打开*/
		private function IsUIOpened(moduleUI:Class,callBack:Function,isList:Boolean=false):void{
			Laya.timer.frameLoop(1, this, GuideView_CheckUIOpened);
			function GuideView_CheckUIOpened():void{
				
				var targetView:BaseView;
				targetView = XFacade.instance.getView(moduleUI) as BaseView;
				
				var open:Boolean = false;
				if ( targetView && targetView.displayedInStage){
					open = true;
				}
				
				if ( open )
				{
					Laya.timer.clear(this, GuideView_CheckUIOpened);
					callBack();
				}
			}
		}
