	...
	public class BuildingItem extends BuildingItemUI
	{
		...
		public function set data(v:BuildingVo):void{
			...
			if(this._data){
				...
				this.expTF.text = buildInfo.get_exp.toString();
				var maxNum:Number;
				var curMax:Number;
				var curNum:Number;
		...
		public function get isMax():Boolean{
			return DBBuildingUpgrade.isMax(parseInt(data.building_id));
		}
		
		public function get isMaxNum():Boolean{
			return DBBuildingUpgrade.isMaxNum(parseInt(data.building_id));
		}
	}
}