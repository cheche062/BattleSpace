package game.module.TeamCopy
{
	...
	public class TeamCopyMainView extends BaseView
	{
		...
		private function initLevel():void
		{
			...
			if(day_number<m_teamCopyVo.combat_number)
			{
				view.NumText.text="0/"+day_number;
				view.CreationBtn.disabled = true;
			}
			else
			{
				view.NumText.text=day_number-m_teamCopyVo.combat_number+"/"+day_number;
			}
			if(levelVo.double==1)
			{
		...
		private function onClickHandler(e:Event):void
		{
			...
			switch(e.target)
			{
				...
				case view.CreationBtn:
				{
					...
					if(m_teamCopyVo.combat_number<day_number)
					{
