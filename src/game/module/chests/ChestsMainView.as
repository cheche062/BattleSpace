package game.module.chests
{
	...
	public class ChestsMainView extends BaseView
	{
		...
		private function setDrawCardInfo():void
		{
			...
			if (m_cardItem1) {
//				m_cardItem1.doClearTimerHandler();
				m_cardItem1.destroy();
			}
		...
		private function onSetDrawCardBtn():void
		{
			...
			{//十连抽1
				...
				if(exploration_sale.length !=0 && Number(exploration_sale[1].discount)&&Number(exploration_sale[1].discount)!=100){
					l_arr[1] *= (Number((100-exploration_sale[1].discount)/100));
				}
			...
			{//十连抽2
				...
				if(exploration_sale.length !=0 && Number(exploration_sale[2].discount)&&Number(exploration_sale[2].discount)!=100){
					l_arr[1] *= (Number((100-exploration_sale[2].discount)/100));
				}
				this.view.TenTimeBtn.text.text=GameLanguage.getLangByKey("L_A_45008");
			}else if(m_DardCardType==5)
			{//十连抽3
				...
				if(exploration_sale.length !=0 && Number(exploration_sale[3].discount)&&Number(exploration_sale[3].discount)!=100){
					l_arr[1] *= (Number((100-exploration_sale[3].discount)/100));
				}
				this.view.TenTimeBtn.text.text=GameLanguage.getLangByKey("L_A_45008");
			}
			else if(m_DardCardType==6)
		...
		public function setBtnText():void
		{
			...
			switch(m_selectCardIndex)
			{
				case 1:
					...
					if(exploration_sale.length !=0 && Number(exploration_sale[1].discount)&&Number(exploration_sale[1].discount)!=100){
						m_tenTimeNum *= (Number((100-exploration_sale[1].discount)/100));
					}
					break;
				case 2:
					...
					if(exploration_sale.length !=0 && Number(exploration_sale[2].discount)&&Number(exploration_sale[2].discount)!=100){
						m_tenTimeNum *= (Number((100-exploration_sale[2].discount)/100));
					}
					break;
				case 3:
					m_onceCostNum=GameConfigManager.card_param.waterCostOnce;
					...
					l_id=GameConfigManager.card_param.waterId;
					if(exploration_sale.length !=0 && Number(exploration_sale[3].discount)&&Number(exploration_sale[3].discount)!=100){
						m_tenTimeNum *= (Number((100-exploration_sale[3].discount)/100));
					}
					break;
			}
