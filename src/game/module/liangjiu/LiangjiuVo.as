package game.module.liangjiu
{
	...
	public class LiangjiuVo
	{
		...
		/***根据晶石数量获取数据*/
		public function getJingshiDataArray(data:Array):Array {
			var current_data = {};
			data.forEach(function(item) {
				current_data[item[0]] = item[1];
			});
			var result = LiangjiuView.total_jingshi.map(function(item) {
				return {
					"js_id": item,
		...
		/**晶石皮肤*/
		public function getJingshiSkin(id:int):String{
