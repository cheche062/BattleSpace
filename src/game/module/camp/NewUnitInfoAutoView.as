package game.module.camp
{
	...
	import game.module.camp.talent.TalentEvent;
	import game.module.camp.talent.TalentView;
...
//						WebSocketNetService.instance.sendData(ServiceConst.TALENT_GETINFO,[selectAmData.unitId]);
		...
		public function showTalentInfo():void
		{
			var view:TalentView = _listPanel.getPanel(4) as TalentView;
			if(view)
			{
				view.selectAmData = selectAmData;
			}
		}
...
//			Signal.intance.on(ServiceConst.getServerEventKey(ServiceConst.TALENT_GETINFO),this,showTalentInfo);
...
//			Signal.intance.off(ServiceConst.getServerEventKey(ServiceConst.TALENT_GETINFO),this,showTalentInfo);
		}
