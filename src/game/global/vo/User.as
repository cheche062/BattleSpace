package game.global.vo
{
	...
	public class User
	{
		...
		private var _hasFinishGuide:Boolean = true;
		 ...
		 * 进游戏是否打开过HotEvents
		 */
		public var hasOpenHotEvents:Boolean = false;
		
		/**
		 * 今天是否可以弹出HotEvents，1弹出，0不弹
		 */
		public var pop_hotevents:int = 1;
		...
		public var inToPvp:Boolean = false;
		 ...
		 * 是否完成了新手引导
		 */
		public function get hasFinishGuide():Boolean
		{
			return _hasFinishGuide;
		}

		/**
		 * @private
		 */
		public function set hasFinishGuide(value:Boolean):void
		{
			_hasFinishGuide = value;
		}
