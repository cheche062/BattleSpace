...
//		'30709' => ['CTL'=>'baseRob',          'ACT'=>'revenge',               'DESC'=>'复仇'],
		...
		// ---------------------- pvp 1vs1
		/**	基本信息 */		
		public static const PVP_GETINFO:int = 50050;
		/**	布阵 */		
		public static const PVP_LINEUP:int = 50051;
		/**	保存阵型 */		
		public static const PVP_SAVELINEUP:int = 50052;
		/**	pvp匹配 */		
		public static const PVP_MATCH:int = 50053;
		
		public static const PVP_SHOP_BUY:uint=50054;
		
		/**	领取积分奖励 */		
		public static const PVP_GETINTEGRAL:int = 50055;
		
		public static const PVP_RANK:uint=50056;
		/**	pvp购买buff */		
		public static const PVP_BUYBUFF:int = 50057;
		/**	pvp排行奖励 */		
		public static const PVP_GETREWARD:int = 50058;
		/**	pvp开战 */		
		public static const PVP_FIGHTSTART:int = 50059;
