...
package game.common
{
	...
	public class starBar extends Sprite
	{
		...
		//某些星星需要替换不同颜色，所以根据兵种的稀有度来改变星星的图片颜色
		public function starColor(index:Number):void
		{
			var arrColor =["common/sectorBar/star_2.png",
				"common/sectorBar/star_2_1.png",
				"common/sectorBar/star_2_2.png",
				"common/sectorBar/star_2_3.png",
				"common/sectorBar/star_2_4.png",
				"common/sectorBar/star_2_5.png"];
			if(index<0 || index>= arrColor.length){
				return;
			}
			m_imgUrl1 = arrColor[index];
			changeValue();
		}
		...
		public function changeValue():void{
			...
			for (var i:int = 0; i < m_maxStar; i++) 
			{
				...
				this.graphics.loadImage(opImg,opx,opy);
