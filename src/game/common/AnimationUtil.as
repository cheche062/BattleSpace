package game.common
{
	...
	public class AnimationUtil
	{
		...
		private static function doFlow(target:Sprite, add:Boolean=true):void{
			...
			function step1():void{
				Tween.to(target, {y:tarY-50}, this.flowSpeed, Ease.linearInOut, Handler.create(null, step2));
			}
			
			function step2():void{
				Tween.to(target, {y:tarY}, this.flowSpeed, Ease.linearInOut, Handler.create(null, step1));
			}
