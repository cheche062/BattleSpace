...
//			alert("socket  connet  succese!");
		...
		private function socketCloseHandler(e:*=null):void{
			...
			if(str == "L_A_900007"){
				...
				var shebei = GameSetting.getLaiyuanShebei();
				var data = 'type=cflash&typeid=1&version=1.0&sub=1&step=interrupted&ouid='+GameSetting.Login_UID+'&platform='+shebei+'&serverid=5&' +
